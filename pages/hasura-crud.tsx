...
// 親コンポネント（hasura-crud.tsx）　→ 子コンポネント(UserItem.tsx)にpropsを渡す
// Memo化する → 親のページのTextFiledが更新されると子コンポネントの方も更新されてしまう。それを防ぐための処理。
// picks でデータ型から好きなフィールドを取り出す。